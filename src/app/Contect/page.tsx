...
function Contect() {
  ...
  return (
    ...
    <div id="section-contect  "
      className="max-w-3xl mx-auto p-4 my-20 "
      style={{
...
<h3 className="text-3xl font-extrabold ">Send us your email here </h3>
      ...
      >
        {/* left */}
        <div
          className="flex flex-col space-y-5 shadow-2xl  shadow-cyan-600
            max-w-xs md:w-fit px-10 py-4 dark:border-x-2 dark:border-gray-300"
       data-aos = "fade-left" >
          <div className="flex  space-x-3">
            {/* one */}
            <BsFillPersonCheckFill className="text-2xl" />
            <h1 className="font-DM   text-sm font-bold text-gray-800 
            dark:text-white">
              Abdiladif salah..
            </h1>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            <h1 className="font-DM text-sm  font-bold">
        ...
        <div>
          <form
            className="md:w-full max-w-md space-y-2   p-10"
            onSubmit={sendEmail}
          ...
          >
            ...
            <input
              className="md:w-96 w-fit p-3 border-2 border-cyan-500
            ...
            <input
              type="text"
              className="md:w-96 w-fit px-3 py-8 border-2 border-cyan-500
              focus:outline-none focus:ring-indigo-500  focus:border-indigo-600
              shadow-2xl shadow-cyan-600 rounded-2xl"
              placeholder="mesage"
              name="message"
